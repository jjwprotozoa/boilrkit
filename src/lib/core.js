...
async function createApp(options = {}) {
  ...
  const answers = await inquirer.getProjectDetails(userConfig, options);
 ...
 */
async function runSetupSteps(answers) {
 ...
 * @param {Object} answers User configuration answers
 */
async function finalSetup(answers) {
 ...
 * @param {Object} answers User configuration answers
 */
function showSuccessSummary(projectPath, answers) {
  const summary = `
